...
<div class="mb-6">
    ...
    <input type="text" id="poblacion" name="poblacion" value="{{$perito->poblacion ?? ''}}" class="w-full rounded-md border border-gray-300 py-2 px-3 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500">
</div>
<div class="mb-6">
    <label for="provincia" class="block text-sm font-medium text-gray-700 mb-2">Ciudad / provincia</label>
    <input type="text" id="provincia" name="provincia" value="{{$perito->provincia ?? '' }}" class="w-full rounded-md border border-gray-300 py-2 px-3 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500">
</div>