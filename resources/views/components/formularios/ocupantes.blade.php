            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text"  name="{{$tipo}}_nombre" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm"  maxlength="100">
                    </div>
                     <div>
                        <label class="block text-sm font-medium text-gray-700" for="apellidos">Apellidos</label>
                        <input type="text"  name="{{$tipo}}_apellidos" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm"  maxlength="100">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700" for="dni">Dni</label>
                        <input type="text"  name="{{$tipo}}_dni" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm"   maxlength="15">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700" for="posicion">Posición</label>
                        <input type="text"  name="{{$tipo}}_posicion" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm" value="Conductor">
                    </div>
                    <div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text"  name="{{$tipo}}_posicion_cuello" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500"> </input>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700" for="mirada">Mirada</label>
                        <input type="text" name="{{$tipo}}_mirada" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500"></input>
                    </div>
                </div>
