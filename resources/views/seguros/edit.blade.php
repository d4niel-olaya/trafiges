...
@section('title', 'Crear Compañia de seguros')

@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6 flex items-center justify-between">
    
        <button class="inline-flex items-center text-gray-600 hover:text-gray-900 transition-colors focus:outline-none" onclick="window.location.href='/seguros'">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="flex items-start justify-betweem p-6 border-b border-gray-200">
            <div>
                <h2 class="text-xl font-semibold text-gray-900">Editar Compañia de seguros</h2>
            </div>
        </div>
        <div class="p-6">
            <div class="w-full">
                        ...
                        <div class="py-6">
                            <div class="tab-content">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8">
                                    ...
                                    @include("seguros.partials.form",["compania"=>$compania])
...
@push("scripts")
@vite('resources/js/seguros/edit.js')
@endpush