...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="flex items-start justify-betweem p-6 border-b border-gray-200">
            <div>
                <h2 class="text-xl font-semibold text-gray-900">Crear Abogado</h2>
            </div>
        </div>
        <div class="p-6">
            <div class="w-full">
                            ...
                            <div class="tab-content">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input type="text" id="despacho" name="despacho" class="w-full rounded-md border border-gray-300 py-2 px-3 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500">
                                    </div>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <input type="text" id="notas" name="notas" class="w-full rounded-md border border-gray-300 py-2 px-3 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500">
                                    </div>
                                       <div class="mb-6">
                                        <label for="poblacion" class="block text-sm font-medium text-gray-700 mb-2">Poblacion</label>
                                    ...
                                    <div class="mb-6">
                                        <label for="provincia" class="block text-sm font-medium text-gray-700 mb-2">Ciudad</label>
...
@push("scripts")
@vite('resources/js/abogados/create.js')
@endpush