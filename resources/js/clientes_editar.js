...
document.addEventListener('DOMContentLoaded', () => {
    ...
    btnGuardarCambios.addEventListener('click', (e) => {
        ...
        const formData = {
            ...
            idAbogado: document.querySelector('select[id="abogadoAsociado"]').value, // id del abogado asociado
        ...
        ajaxHandler.sendRequest('/clientes/update', formData, 'PATCH', true, true, (response) => {
