    ...
    btnGuardarCambios.addEventListener('click', (e) => {
        ...
        const formData = {
           id: document.querySelector('input[id="id"]')?.value || null,
            ...
            contacto: document.querySelector('input[id="contacto"]').value,
            telefono: document.querySelector('input[id="telefono"]').value,
            email: document.querySelector('input[id="email"]').value,
            direccion: document.querySelector('textarea[id="direccion"]').value,
        ...
        ajaxHandler.sendRequest('/seguros/update', formData, 'PATCH', true, true, (response) => {
