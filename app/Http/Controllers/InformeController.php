...
class InformeController extends Controller
{
    ...
    // Generar un nuevo ID basado en el último ID
        ...
        $validatedData = $request->validate([
            ...
            'ciudad_testigo' => 'nullable|string|max:100',
            'direccion_testigo' => 'nullable|string|max:100',
            'cp_testigo' => 'nullable|string|max:100',
            'poblacion_testigo' => 'nullable|string|max:100',
        ]);
        ...
        $id_informe = DB::table('informes')->insertGetId([
           ...
           // 'peritoAsignado' => $validatedData['peritoAsignado'],
            ...
            'nombre_testigo' => $validatedData['nombre_testigo'] ?? null,
            'apellido_testigo' => $validatedData['apellido_testigo'] ?? null,
            'direccion_testigo' => $validatedData['direccion_testigo'] ?? null,
            'ciudad_testigo' => $validatedData['ciudad_testigo'] ?? null,
            'poblacion_testigo' => $validatedData['poblacion_testigo'] ?? null,
            'cp_testigo' => $validatedData['cp_testigo'] ?? null,
       ...
       DB::table('resultados_biomecanicos')
        ...
        foreach ($validatedData['ocupantes'] as $ocupante) {
          ...
          DB::table('datos_vehiculos')->insert([
                ...
                'clase' => $validatedData['vehiculo1']['clase'] ?? null,
                'fecha_fabricacion' => $validatedData['vehiculo1']['fecha_fabricacion'] ?? null,
                'tara' => $validatedData['vehiculo1']['tara'] ?? null,
                'numero_ocupantes' => $validatedData['vehiculo1']['numOcupantes'] ?? null,
                'id_informe' => $id_informe,
            ...
            DB::table('datos_vehiculos')->insert([
                ...
                'clase' => $validatedData['vehiculo2']['clase'] ?? null,
                'fecha_fabricacion' => $validatedData['vehiculo2']['fecha_fabricacion'] ?? null,
                'tara' => $validatedData['vehiculo2']['tara'] ?? null,
                'numero_ocupantes' => $validatedData['vehiculo2']['numOcupantes'] ?? null,
                'id_informe' => $id_informe,
    ...
    public function update(Request $request)
    {
        ...
        DB::table('informes')
            ...
            DB::table('datos_vehiculos')->insert([
                ...
                'fecha_fabricacion' => $validatedData['vehiculo1']['fecha_fabricacion'] ?? null,
                'tara' => $validatedData['vehiculo1']['tara'] ?? null,
                'danios' => $validatedData['vehiculo1']['danios'] ?? null,
                'numero_ocupantes' => $validatedData['vehiculo1']['numOcupantes'] ?? null,
            ...
            DB::table('datos_vehiculos')->insert([
                ...
                'clase' => $validatedData['vehiculo2']['clase'] ?? null,
                'fecha_fabricacion' => $validatedData['vehiculo2']['fecha_fabricacion'] ?? null,
                'danios' => $validatedData['vehiculo2']['danios'] ?? null,
                'numero_ocupantes' => $validatedData['vehiculo2']['numOcupantes'] ?? null,
                'id_informe' => $validatedData['id'],
                'velocidad' => $validatedData['vehiculo2']['velocidad'] ?? null,
                'pesoOcupantes' => $validatedData['vehiculo2']['pesoOcupantes'] ?? null,
